...
public class Usuario {
   ...
   public Usuario(Integer id, String nombre, String apellido, String correo, String direccion,
			String telefono, String tipo, String contrasena, String cedula, List<Producto> producto,
			List<Orden> orden) {
		super();
		this.id = id;
		this.nombre = nombre;
